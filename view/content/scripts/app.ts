...
(function(){
    ...
    function AjaxRequest(method:string, url:string, callback:(responseText: string)=> void){
    ...
    function DisplayContactPage() {
        ...
        let sendButton = document.getElementById("sendButton") as HTMLButtonElement | null;
        let subscribeCheckbox = document.getElementById("subscribeCheckbox") as HTMLInputElement | null;

        if (sendButton && subscribeCheckbox?.checked) {
            ...
            console.error("sendButton or subscribeCheckbox is null.");
        }
    }
    ...
    function DisplayContactListPage(){
        ...
        if(localStorage.length >0){
            ...
            console.error("contactList is null. Unable to retrieve element.");
